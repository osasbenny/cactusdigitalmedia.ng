...
var ENV = {
  ...
  smtpFrom: process.env.SMTP_FROM ?? "Cactus Digital Media <noreply@cactusdigitalmedia.ng>"
};
...
<body>
  <div class="container">
    <div class="header">
      <h1>\u{1F335} New Project Inquiry</h1>
  ...
  contact: router({
    submit: publicProcedure.input(
      z2.object({
        ...
        projectType: z2.string().min(1, "Please select a project type"),
        budget: z2.string().min(1, "Please select a budget range"),
